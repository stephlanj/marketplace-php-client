    ...
    <div id="data">
      <table id="offers_query_table" class="table">
        ...
        <?php foreach($offers as $offer): ?>
          <tr>
            ...
            <td>&nbsp;</td>
            <?php endif; ?>
            <td><a class="product_link" href="<?php echo $offer->getProductUrl(); ?>"><?php echo $offer->getProductName(); ?></a></td>
      ...
      <script type="text/javascript">
        function updateOffer(id, sku)
        {
          ...
          window.location = "offers_query.php?page=<?php echo $page ?>&action=update&offer_sku=" + sku + "&quantity=" + quantity + "&price=" + price;
        }
